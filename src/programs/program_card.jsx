            ...
            <div className="element grid classic4_cols animated4">
                ...
                >
                    ...
                    <div className="portfolio_info_wrapper">
                        ...
                        <Link to={`/program/${props.id}`}><h4>{props.name}</h4></Link>
                        <h6 style={{color: "white"}}><i
                            className="bi bi-calendar-date"></i> &nbsp; {props.date} {props.date === props.endDate ? null : (
                            <span> /{props.endDate}</span>)}</h6>
