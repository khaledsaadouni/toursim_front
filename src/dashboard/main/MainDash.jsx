    ...
    return (
        <React.Fragment>
            ...
            <div
                ...
                <iframe title="maybe" width="1500" height="650"
                        src="https://app.powerbi.com/view?r=eyJrIjoiYjM1MjgzMzAtYzliZC00OTM3LTgxZjgtYmUxZTQ3Mjg0NDcxIiwidCI6ImRiZDY2NjRkLTRlYjktNDZlYi05OWQ4LTVjNDNiYTE1M2M2MSIsImMiOjl9&pageName=ReportSection3a3eadfc0d359730312a"
                ...
                {/*                <p className="text-sm "> (<span className="font-weight-bolder">+15%</span>) increase*/}
                {/*                    in today sales. </p>*/}
                {/*                <div className="dark horizontal">*/}
                {/*                    <div className="d-flex ">*/}
                {/*                        <i className="material-icons text-sm my-auto me-1">schedule</i>*/}
                ...
                {/*                    <div className="chart">*/}
                {/*                        <canvas id="chart-line-tasks" className="chart-canvas"*/}
                {/*                                height="170"></canvas>*/}
                {/*                    </div>*/}
                {/*                </div>*/}
                {/*            </div>*/}
                ...
                {/*                                <li><a className="dropdown-item border-radius-md"*/}
                ...
                {/*                                        <div className="progress-bar bg-gradient-info w-60"*/}
                ...
                {/*                                    </div>*/}
                {/*                                    <div className="progress">*/}
                {/*                                        <div className="progress-bar bg-gradient-info w-10"*/}
                ...
                {/*                                    </div>*/}
                {/*                                    <div className="progress">*/}
                {/*                                        <div className="progress-bar bg-gradient-success w-100"*/}
                ...
                {/*                                    </div>*/}
                {/*                                    <div className="progress">*/}
                {/*                                        <div className="progress-bar bg-gradient-info w-25"*/}
                ...
                {/*                                    </div>*/}
                {/*                                    <div className="progress">*/}
                {/*                                        <div className="progress-bar bg-gradient-info w-40"*/}
                ...
                {/*                            <h6 className="text-dark text-sm font-weight-bold mb-0">$2400, Design*/}
                {/*                                changes</h6>*/}
                {/*                            <p className="text-secondary font-weight-bold text-xs mt-1 mb-0">22 DEC*/}
                {/*                                7:20 PM</p>*/}
                {/*                        </div>*/}
                {/*                    </div>*/}
                {/*                    <div className="timeline-block mb-3">*/}
                ...
                {/*  </span>*/}
                {/*                        <div className="timeline-content">*/}
                {/*                            <h6 className="text-dark text-sm font-weight-bold mb-0">New order*/}
                {/*                                #1832412</h6>*/}
                {/*                            <p className="text-secondary font-weight-bold text-xs mt-1 mb-0">21 DEC*/}
                {/*                                11 PM</p>*/}
                {/*                        </div>*/}
                {/*                    </div>*/}
                {/*                    <div className="timeline-block mb-3">*/}
                ...
                {/*  </span>*/}
                {/*                        <div className="timeline-content">*/}
                {/*                            <h6 className="text-dark text-sm font-weight-bold mb-0">Server payments*/}
                {/*                                for April</h6>*/}
                {/*                            <p className="text-secondary font-weight-bold text-xs mt-1 mb-0">21 DEC*/}
                {/*                                9:34 PM</p>*/}
                {/*                        </div>*/}
                ...
                {/*  </span>*/}
                {/*                        <div className="timeline-content">*/}
                {/*                            <h6 className="text-dark text-sm font-weight-bold mb-0">New card added*/}
                {/*                                for order #4395133</h6>*/}
                {/*                            <p className="text-secondary font-weight-bold text-xs mt-1 mb-0">20 DEC*/}
                {/*                                2:20 AM</p>*/}
                {/*                        </div>*/}
                {/*                    </div>*/}
                {/*                    <div className="timeline-block mb-3">*/}
                ...
                {/*  </span>*/}
                {/*                        <div className="timeline-content">*/}
                {/*                            <h6 className="text-dark text-sm font-weight-bold mb-0">Unlock packages*/}
                {/*                                for development</h6>*/}
                {/*                            <p className="text-secondary font-weight-bold text-xs mt-1 mb-0">18 DEC*/}
                {/*                                4:54 AM</p>*/}
                {/*                        </div>*/}
                {/*                    </div>*/}
