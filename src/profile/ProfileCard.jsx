...
const ProfileCard = () => {
    ...
    return jwt === "" ? <Navigate to="/" /> : (
        <React.Fragment>
            <div className="container-fluid py-4" style={{width: "1000px", marginTop: "50px"}}>
                                        ...
                                        <div className="col">
                                            <div className="card card-plain h-100">
                                                <div className="card-header pb-0">
                                                    <h6 className="mb-0">Payement Method with Stripe :</h6>
                                                </div>
                                                <div className="card-body">
                                                    <div className="row">
                                                        <div className="col">
                                                            <div className="row">
                                                                <div className="col-xl-9 mb-xl-0 ">
                                                                    <div className="card bg-transparent shadow-xl">
                                                                        <div
                                                                            ...
                                                                            <div
                                                                                className="card-body position-relative z-index-1 ">
                                                                                <i className="material-icons text-white p-2">wifi</i>
                                                                                <p className="text-white mt-4 mb-5 pb-2">your public key : {user.publicKey} </p>
